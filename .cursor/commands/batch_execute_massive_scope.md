...
**Local Reference**: `commands/batch_execute_massive_scope.md`
**Git URL Reference**: `https://github.com/dadosfera/docs-fera/blob/main/commands/batch_execute_massive_scope.md`
