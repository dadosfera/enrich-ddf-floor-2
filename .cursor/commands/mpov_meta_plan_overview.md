# /mpov_meta_plan_overview

Overview of the master meta plan for plans and projects, along with related mini prompts and guides. This command provides a comprehensive read-only view of repository coordination artifacts.
...
- **`/mpov_meta_plan_overview`** (this command): Read-only overview of meta plans, projects, and coordination artifacts.
...
- **`/revw_review`**: Review conversation tasks (focuses on task extraction, not meta plan coordination).
