...
**Local Reference**: `commands/expp_expand_plan.md`
**Git URL Reference**: `https://github.com/dadosfera/docs-fera/blob/main/commands/expp_expand_plan.md`
...
**See**: `guides/commands/expp_expand_plan_guide.md` for expansion templates.
...
```bash
# Standard expansion
/expp_expand_plan plans/active/QW_feature.md

# Offline mode
/expp_expand_plan plans/active/QW_feature.md false

# Comprehensive mode
/expp_expand_plan plans/active/QW_feature.md true comprehensive
```

## Reference
For detailed templates, logic, and examples, see:
- `guides/commands/expp_expand_plan_guide.md`
