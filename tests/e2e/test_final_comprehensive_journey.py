...
2. API functionality with correct field requirements
...
def test_api_create_company(base_url, test_data):
    """Test creating a company via API with correct fields."""
...
def test_api_create_contact(base_url, test_data):
    """Test creating a contact via API with correct fields."""
...
def test_api_create_product(base_url, test_data):
    """Test creating a product via API with correct fields."""
...
def main():
    ...
    test_data = {
        "company": {
            "name": "Comprehensive Test Company E2E",
            "domain": "comprehensivetest-e2e.com",
            "industry": "Technology",
            "website": "https://comprehensivetest-e2e.com",
            "description": "Comprehensive test company for E2E testing",
        },
        "contact": {
            "first_name": "Comprehensive",
            "last_name": "Tester",
            "email": "comprehensive.tester@comprehensivetest-e2e.com",
            "phone": "+1-555-0128",
            "job_title": "Comprehensive Test Engineer",
        },
        "product": {
            "name": "Comprehensive Test Product E2E",
            "sku": "COMPREHENSIVE-TEST-PROD-E2E-001",
            "description": "A comprehensive test product for E2E testing",
            "price": 599.99,
            "category": "Comprehensive Software",
        },
    }
