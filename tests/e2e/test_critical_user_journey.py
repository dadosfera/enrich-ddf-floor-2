...
class TestCriticalUserJourney:
    ...
    def test_01_application_health_check(
    ...
    def test_02_api_documentation_access(
        self, page: Page, base_url: str
    ):
    ...
    def test_03_create_company_via_api(self, page: Page, base_url: str, test_data: dict):
    ...
    def test_04_create_contact_via_api(self, page: Page, base_url: str, test_data: dict):
    ...
    def test_05_create_product_via_api(self, page: Page, base_url: str, test_data: dict):
    ...
    def test_06_verify_all_data_created(self, page: Page, base_url: str, test_data: dict):
