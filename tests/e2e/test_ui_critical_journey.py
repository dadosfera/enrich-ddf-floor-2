...
def test_ui_health_check(page, base_url):
    ...
    try:
        ...
        print(f"✅ UI Health check passed - Status: {health_data['status']}, "
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            tests = [
                ...
                ("UI Create Contact", lambda: test_ui_create_contact_via_docs(page, base_url, test_data)),
                ("UI Create Product", lambda: test_ui_create_product_via_docs(page, base_url, test_data)),
