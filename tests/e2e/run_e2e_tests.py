    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            tests = [
                ...
                ("Create Company", lambda: test_create_company(page, base_url, test_data)),
                ("Create Contact", lambda: test_create_contact(page, base_url, test_data)),
                ("Create Product", lambda: test_create_product(page, base_url, test_data)),
            ]
