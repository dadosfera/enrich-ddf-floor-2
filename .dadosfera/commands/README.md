...
- **[Adding a New Command Guide](docs-fedocs-fera/guides/cursor_commands_sync.md#adding-a-new-command)**
...
See `docs-fedocs-fera/guides/cursor_commands_sync.md` for the complete list of canonical commands.
```
