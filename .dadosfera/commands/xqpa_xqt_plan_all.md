...
/xqpa_xqt_plan_all --verbose

# Execute only unlocked plans (default behavior)
/xqpa_xqt_plan_all --skip-locked
```
...
| ------------------------------ | ---------------------------------- | ----------------- | ------------- |
| `/xqpa_xqt_plan_all`           | Execute ALL plans simply           | Any               | Minimal       |
| `/xect_execute_plan`           | Execute conversation-related plan  | Any               | Minimal       |
| `/plca_complete_all_active`    | Verify + detect overlaps + execute | High-register     | Comprehensive |
| `/exal_xpand_all_active_plans` | Expand/show plans (no execution)   | Any               | None          |
...
- **`/xect_execute_plan`**: Execute single conversation-related plan
- **`/plca_complete_all_active`**: Complex verification and execution (high-register)
- **`/exal_xpand_all_active_plans`**: Expand and review all plans
