# /rciv_investigate_root_cause
<!-- COMMAND_ID: 010 -->
<!-- COMMAND_VERSION: 1.1.0 -->
<!-- COMMAND_TYPE: in_investigate_root_cause -->
...
Use `/rciv_investigate_root_cause` when:
...
- Surface-level investigation isn't enough (use `/depi_enhanced_deep_investigation` instead)
...
4. **Further investigation**: If more information is needed, use `/depi_enhanced_deep_investigation` to add instrumentation
...
Status:
  ...
  - Option 4: Deep investigation with /depi_enhanced_deep_investigation
...
```
# After /rciv_investigate_root_cause completes:
...
```
# After /rciv_investigate_root_cause completes (but didn't provide enough insight):
...
- `/depi_enhanced_deep_investigation` - Add instrumentation for deeper investigation
